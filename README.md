...
**体验地址**：[wk ImgHub (demo-cloudflare-imgbed.pages.dev)](https://demo-cloudflare-imgbed.pages.dev/)
...
1. 安装服务器操作系统对应的`node.js`，经测试`v22.5.1`版本可以正常使用。（安装教程自行 search）
...
### 5.1 未设置`ALLOWED_DOMAINS`，但无法跨域访问？
